        ...
        private static void rightFeedback()
        {
            ...
            switch (num)
            {
                case 1:
                    ...
                    break;
                case 2:
                    Console.WriteLine("Correct! You're on fire!");
                    break;
                case 3:
                    Console.WriteLine("Fantastic! You're doing well!");
                    break;
                case 4:
                    Console.WriteLine("Well done! You're getting it!");
                    break;
                case 5:
                    Console.WriteLine("Excellent! You're a math whiz!");
                    break;
                case 6:
                    Console.WriteLine("Perfect! You've got the hang of it!");
                    break;
                case 7:
                    Console.WriteLine("Awesome! You're mastering these problems!");
                    break;
                default:
